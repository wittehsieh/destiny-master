/*
 * lunar-typescript (MIT License) by 6tail
 * https://github.com/6tail/lunar-typescript
 * Vendored ESM build (dist/index.mjs) converted to a plain browser
 * script by replacing the trailing `export {...}` with a
 * `window.LunarTS = {...}` assignment -- no other changes.
 */
...
let ShouXingUtil = _ShouXingUtil;
...
window.LunarTS = { DaYun, EightChar, Foto, FotoUtil, Fu, Holiday, HolidayUtil, I18n, JieQi, LiuNian, LiuYue, Lunar, LunarMonth, LunarTime, LunarUtil, LunarYear, NineStar, NineStarUtil, ShouXingUtil, ShuJiu, Solar, SolarHalfYear, SolarMonth, SolarSeason, SolarUtil, SolarWeek, SolarYear, Tao, TaoUtil, XiaoYun, Yun };
